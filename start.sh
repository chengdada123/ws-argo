...
export NEZHA_KEY=${NEZHA_KEY:-'FWFs3gQb2sju7aH0T6'}
export TLS=${TLS:-'0'}
export ARGO_DOMAIN=${ARGO_DOMAIN:-'vercle.golo.eu.org'}
export WEB_DOMAIN=${WEB_DOMAIN:-''}
export ARGO_AUTH=${ARGO_AUTH:-'eyJhIjoiOTMyODFhODZhOThlMzgyMWNjNzA2NmY1ODBhODI1MzkiLCJ0IjoiODgwYTkyYTYtYmNmOS00ZjZlLThmYWEtNDBkMDk3NTY4NTU1IiwicyI6Ill6RTVOV0k0TVRrdE5XRmxOUzAwTVdVeUxUa3pNVGN0Tmpaa1lqSmxOMk13WkRrNSJ9'}
